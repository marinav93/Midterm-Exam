...
def convert_2_upper(recenica):
    ...
    for karakter in recenica: # prolazimo kroz svaki karakter u recenici
        broj_chr = ord(karakter) # svaki karakter pretvaramo u ASCII kod(odgovarajuci broj)
        if broj_chr > 96 and broj_chr < 123: # mala slova u ASCII kodu pocinju sa 97 i zavrsavaju sa 122,a velika su od 65-90
    ...
    return nova_recenica # fja vraca novu recenicu,koja je sada ispisana velikim slovima

def main():

    recenica= "MaRiNa VaSoViC"
    print("Data recenica napisana velikim slovima : ", convert_2_upper(recenics))
