...
n = int(input("Koliko brojeva unosite? "))  # da bi znali kolika ce biti duzina liste,mora biti cijeli br

lista = [] # na poovetki je data prazna lista
...
for i in range(n): # koliko lista ima clanova,toliko cemo puta pitati korisnika da unese novi clan liste
    ...
    if novi_broj < 0: #  ako je unijeti broj manji od nule,ukupan broj negativnih se uveca za 1
        negativni += 1
    else:      # u susprotnom se uveca broj nenegativnih za 1
        nenegativni += 1
